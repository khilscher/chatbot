...
namespace EGDChatBot.Dialogs
{
    ...
    public class CardsDialog : IDialog<object>
    {
        ...
        private IEnumerable<string> options = new List<string> { HeroCard, ThumbnailCard, ReceiptCard, SigninCard, AnimationCard, VideoCard, AudioCard, Quit };
        ...
        public async Task Prompt(IDialogContext context)
        {
            PromptDialog.Choice<string>(
                context,
                this.DisplaySelectedCard,
